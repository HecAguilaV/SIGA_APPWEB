<script lang="ts">
  ...
  import { Microphone, Robot, PaperPlaneTilt, X } from './IconosPhosphor.js';
...
<div class="asistente-contextual {estaAbierto ? 'is-open' : ''}">
  ...
  >
  <Robot size={38} color="#03045E" weight="duotone" class="siga-logo" />
  </button>
  ...
  {#if estaAbierto}
    ...
    >
      ...
      <div class="panel-header" on:mousedown={iniciarArrastre} role="button" tabindex="0">
        <h3><Robot size={22} color="#00B4D8" weight="duotone" style="vertical-align: middle; margin-right: 0.5em;"/> SIGA Asistente</h3>
        <button
          type="button"
        ...
        >
          <Microphone size={22} color={estamosUsandoVoz ? '#00B4D8' : '#03045E'} weight="duotone" />
        </button>
      </div>
      ...
      <div class="mensajes-area" bind:this={mensajesContainer}>
        {#if mensajes.length === 0}
          <div class="mensaje-bienvenida">
            <p><strong>¡Hola! <Robot size={18} color="#00B4D8" weight="duotone" style="vertical-align: middle;"/></strong></p>
            <p>Soy tu asistente SIGA. Puedo ayudarte con:</p>
            <ul class="bienvenida-lista">
              <li><PaperPlaneTilt size={16} color="#00B4D8" weight="duotone" style="vertical-align: middle; margin-right: 0.3em;"/> Análisis de ventas y tendencias</li>
              <li><PaperPlaneTilt size={16} color="#00B4D8" weight="duotone" style="vertical-align: middle; margin-right: 0.3em;"/> Consultas sobre inventario</li>
              <li><PaperPlaneTilt size={16} color="#00B4D8" weight="duotone" style="vertical-align: middle; margin-right: 0.3em;"/> Alertas de stock crítico</li>
              <li><PaperPlaneTilt size={16} color="#00B4D8" weight="duotone" style="vertical-align: middle; margin-right: 0.3em;"/> Recomendaciones de gestión</li>
            </ul>
            <p class="hint">Escribe tu pregunta o usa el micrófono <Microphone size={14} color="#00B4D8" weight="duotone" style="vertical-align: middle;"/></p>
          </div>
        {/if}
      ...
      <form on:submit={manejarEnvio} class="input-area">
        <div class="input-group">
          ...
          >
            <PaperPlaneTilt size={20} color="#00B4D8" weight="duotone" />
          </button>
        </div>
      </form>
    </div>
