<div align="center">
  ...
  [![Estado](https://img.shields.io/badge/estado-MVP-brightgreen)](https://github.com/HecAguilaV/SIGA_PROTOTIPO)
...
1. **Clonar el repositorio:**
   ```bash
   git clone https://github.com/HecAguilaV/SIGA_PROTOTIPO.git
   cd SIGA_PROTOTIPO
   ```
